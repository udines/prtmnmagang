...
public class WaitingTimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.waiting_time_recyclerview);
    ...
    private void handleSpinner() {
        final Spinner spinner = findViewById(R.id.waiting_time_no_bill_spinner);
    ...
    private void getMarineData(int month, int year) {
        ...
        SharedPreferences preferences = WaitingTimeActivity.this.getSharedPreferences(
                "login",
        ...
        Call<ArrayList<WaitingTime>> call = userClient.getWaitingTime(bulan);
        call.enqueue(new Callback<ArrayList<WaitingTime>>() {
            @Override
    ...
    private void checkData(ArrayList<WaitingTime> data) {
    ...
    private void populateData(ArrayList<WaitingTime> data) {
        WaitingTimeAdapter adapter = new WaitingTimeAdapter(data);
