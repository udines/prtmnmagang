...
public class ShipConditionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ship_condition);
        ...
        dateText = findViewById(R.id.ship_condition_text_date);
        recyclerView = findViewById(R.id.ship_condition_recyclerview);
    ...
    private void handleDateButton() {
        LinearLayout dateButton = findViewById(R.id.ship_condition_date);
    ...
    private void getMarineData(int month, int year) {
        ...
        SharedPreferences preferences = ShipConditionActivity.this.getSharedPreferences(
                "login",
        ...
        Call<ArrayList<ShipCondition>> call = userClient.getShipCondition(bulan);

        call.enqueue(new Callback<ArrayList<ShipCondition>>() {
            @Override
            public void onResponse(Call<ArrayList<ShipCondition>> call, Response<ArrayList<ShipCondition>> response) {
            ...
            @Override
            public void onFailure(Call<ArrayList<ShipCondition>> call, Throwable t) {
                Log.w("error", t.getMessage());
                recyclerView.setVisibility(View.GONE);
                Toast.makeText(ShipConditionActivity.this, "Tidak ditemukan data", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void checkData(ArrayList<ShipCondition> data) {
    ...
    private void populateData(ArrayList<ShipCondition> data) {
        ShipConditionAdapter adapter = new ShipConditionAdapter(data);
