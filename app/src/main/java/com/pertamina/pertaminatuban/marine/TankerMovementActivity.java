...
public class TankerMovementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.tanker_movement_recyclerview);
    ...
    private void handleSpinner() {
        final Spinner spinner = findViewById(R.id.tanker_movement_no_bill_spinner);
    ...
    private void getMarineData(int month, int year) {
        ...
        SharedPreferences preferences = TankerMovementActivity.this.getSharedPreferences(
                "login",
        ...
        Call<ArrayList<TankerMovement>> call = userClient.getTankerMovement(bulan);

        call.enqueue(new Callback<ArrayList<TankerMovement>>() {
            @Override
    ...
    private void checkData(ArrayList<TankerMovement> data) {
    ...
    private void populateData(ArrayList<TankerMovement> data) {
        TankerMovementAdapter adapter = new TankerMovementAdapter(data);
