...
import com.pertamina.pertaminatuban.marine.input.InputShipParticularActivity;
...
import com.pertamina.pertaminatuban.marine.utils.ShipParticularAdapter;
...
public class ShipParticularActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dateText = findViewById(R.id.ship_particular_text_date);
        recyclerView = findViewById(R.id.ship_particular_recyclerview);
    ...
    private void handleSpinner() {
        final Spinner spinner = findViewById(R.id.ship_particular_no_bill_spinner);
    ...
    private void handleDateButton() {
        LinearLayout dateButton = findViewById(R.id.ship_particular_date);
    ...
    private void getMarineData(int month, int year) {
        ...
        SharedPreferences preferences = ShipParticularActivity.this.getSharedPreferences(
                "login",
        ...
        Call<ArrayList<ShipParticular>> call = userClient.getShipParticular(bulan);
        call.enqueue(new Callback<ArrayList<ShipParticular>>() {
            @Override
            public void onResponse(Call<ArrayList<ShipParticular>> call, Response<ArrayList<ShipParticular>> response) {
            ...
            @Override
            public void onFailure(Call<ArrayList<ShipParticular>> call, Throwable t) {
                Log.w("error", t.getMessage());
                recyclerView.setVisibility(View.GONE);
                Toast.makeText(ShipParticularActivity.this, "Tidak ditemukan data", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void checkData(ArrayList<ShipParticular> data) {
    ...
    private void populateData(ArrayList<ShipParticular> data) {
        ShipParticularAdapter adapter = new ShipParticularAdapter(data);
    ...
    private void handleInputButton() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                inputIntent.putExtra("sourceActivity", "ShipParticular");
